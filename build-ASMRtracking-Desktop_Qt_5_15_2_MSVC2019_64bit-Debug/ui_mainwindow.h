...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        btnCAMfind = new QPushButton(tabCAMS);
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/others/search"), QSize(), QIcon::Normal, QIcon::Off);
        btnCAMfind->setIcon(icon);
        btnCAMfind->setIconSize(QSize(50, 50));
        btnCAMfind->setCheckable(false);
        btnCAMfind->setFlat(true);
        btnCAMpreview = new QPushButton(tabCAMS);
        ...
        btnCAMremove = new QPushButton(tabCAMS);
        btnCAMremove->setObjectName(QString::fromUtf8("btnCAMremove"));
        btnCAMremove->setGeometry(QRect(190, 150, 51, 51));
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/remove/bin"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8("../icons/004-plus.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        btnHSVpreview->setGeometry(QRect(150, 240, 151, 51));
...
"color: rgb(255, 255, 255);"));
        ...
        gbCOLORname->setGeometry(QRect(150, 150, 151, 81));
        ...
        QIcon icon7;
        icon7.addFile(QString::fromUtf8("../icons/006-edit.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/add/add"), QSize(), QIcon::Normal, QIcon::Off);
        btnAddColour->setIcon(icon8);
        btnAddColour->setIconSize(QSize(30, 30));
        btnAddColour->setFlat(true);
        QIcon icon9;
        icon9.addFile(QString::fromUtf8(":/tabs/filter"), QSize(), QIcon::Normal, QIcon::Off);
        tabCONTROLLER->addTab(tabHSV, icon9, QString());
        ...
        QIcon icon10;
        icon10.addFile(QString::fromUtf8(":/tabs/tracking"), QSize(), QIcon::Normal, QIcon::Off);
        tabCONTROLLER->addTab(tabTRACKING, icon10, QString());
